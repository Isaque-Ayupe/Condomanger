...
CREATE TABLE `moradores` (
  ...
  PRIMARY KEY (`id_moradores`),
  UNIQUE KEY `id` (`id_moradores`),
...
INSERT INTO `moradores` VALUES (2,'cabuloso','144','iojfdgjkgfsd@fasjgf.com','62982999564',NULL),(3,'jorge','6656','jorgecabuloso@gmail.com','6240088922',NULL),(4,'jubilão destroçador','5555','higortga@gmail.com','6113132132132123',NULL);
...
INSERT INTO `reservas` VALUES (1,'salao-festas','2025-09-23','pendente',3,'10:30 - 15:00'),(2,'academia','2025-09-22','pendente',2,'20:00 - 21:00'),(3,'piscina','2025-09-25','pendente',1,'13:00 - 14:00'),(4,'quadra-tenis','2025-09-28','pendente',3,'13:00 - 14:00'),(5,'academia','2025-09-24','pendente',2,'08:00 - 09:00');
